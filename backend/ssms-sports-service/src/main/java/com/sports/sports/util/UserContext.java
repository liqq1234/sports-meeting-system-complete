package com.sports.sports.util;
...
public class UserContext {
    ...
    private static final ThreadLocal<Integer> USER_GENDER_HOLDER = new ThreadLocal<>();
    ...
    public static void setCurrentUserGender(Integer gender) {
        USER_GENDER_HOLDER.set(gender);
    }

    public static Integer getCurrentUserGender() {
        return USER_GENDER_HOLDER.get();
    }
